    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.List<FriendshipDto>> GetFriendshipsAsync(bool? areFriends, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "getfriendships"
                    urlBuilder_.Append("getfriendships");
                    urlBuilder_.Append('?');
                    if (areFriends != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("areFriends")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(areFriends, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    }
                    urlBuilder_.Length--;
        ...
        public virtual async System.Threading.Tasks.Task<Friendship> SendFriendRequestAsync(string friendUserName, System.Threading.CancellationToken cancellationToken)
        {
            if (friendUserName == null)
                throw new System.ArgumentNullException("friendUserName");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "sendfriendrequest"
                    urlBuilder_.Append("sendfriendrequest");
                    urlBuilder_.Append('?');
                    urlBuilder_.Append(System.Uri.EscapeDataString("friendUserName")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(friendUserName, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    urlBuilder_.Length--;
        ...
        public virtual async System.Threading.Tasks.Task ActionFriendRequestAsync(string friendUserName, bool accepted, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "actionfriendrequest"
                    urlBuilder_.Append("actionfriendrequest");
                    urlBuilder_.Append('?');
                    urlBuilder_.Append(System.Uri.EscapeDataString("friendUserName")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(friendUserName, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    urlBuilder_.Append(System.Uri.EscapeDataString("accepted")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(accepted, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    urlBuilder_.Length--;
        ...
        public virtual async System.Threading.Tasks.Task<StatusUserDto> CreateUserAsync(CreateUserDto createUserDto, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    var json_ = System.Text.Json.JsonSerializer.SerializeToUtf8Bytes(createUserDto, _settings.Value);
        ...
        public virtual async System.Threading.Tasks.Task<StatusUserDto> UpdateUserAsync(StatusUserDto statusUserDto, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    var json_ = System.Text.Json.JsonSerializer.SerializeToUtf8Bytes(statusUserDto, _settings.Value);
                    var content_ = new System.Net.Http.ByteArrayContent(json_);
                    content_.Headers.ContentType = System.Net.Http.Headers.MediaTypeHeaderValue.Parse("application/json");
                    request_.Content = content_;
